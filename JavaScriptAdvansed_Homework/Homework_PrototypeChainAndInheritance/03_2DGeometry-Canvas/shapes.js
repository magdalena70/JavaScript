...
var circle = new Shapes.Circle(250, 80, '#FF0000', 65);
console.log(circle.toString());
circle.draw();

var rectangle = new Shapes.Rectangle(100, 160, '#FFFF00', 180, 180);
console.log(rectangle.toString());
rectangle.draw();

var triangle = new Shapes.Triangle(300, 220, '#33AABB', 350, 350, 600, 110);
console.log(triangle.toString());
triangle.draw();

var line = new Shapes.Line(400, 50, '#FFFF00', 500, 100);
console.log(line.toString());
line.draw();

var segment = new Shapes.Segment(550, 200, '#FF0000', 690, 350);
